...
Most of these come down to network reality or how nasacmr serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

nasacmr rate-limits like any public site. nasacmr already paces
...
Where a surface is gated, nasacmr reads a cookie or token you supply
...
`nasacmr`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what nasacmr actually did
