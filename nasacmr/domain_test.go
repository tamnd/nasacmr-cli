...
func TestHostWiring(t *testing.T) {
	...
	if want := "nasacmr://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("nasacmr", "about")
	if err != nil || got.String() != "nasacmr://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want nasacmr://page/about", got.String(), err)
	}
}
